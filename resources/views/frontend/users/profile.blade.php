    ...
    <div class="col-span-1">
        <div class="text-center mb-8 md:mb-0">
            ...
            <div class="bg-white shadow-lg rounded-lg px-8 pt-32 pb-10 text-gray-400">
                ...
                @else
                <a class="text-blue-800 hover:text-gray-800" href="{{route('users.profile', encode_id($$module_name_singular->id))}}">
                    {{route('users.profile', encode_id($$module_name_singular->id))}}
                </a>
                @endif
                ...
                <div class="mt-8">
                    <a href='{{ route("users.profileEdit", encode_id($$module_name_singular->id)) }}'>
                ...
                <div class="mt-8">
                    <a href="{{ route('users.changePassword', $$module_name_singular->username) }}">
                        <div class="w-full text-sm px-6 py-2 transition ease-in duration-200 rounded text-gray-500 hover:bg-gray-800 hover:text-white border-2 border-gray-900 focus:outline-none">
                            Change Password
                        </div>
                    </a>
