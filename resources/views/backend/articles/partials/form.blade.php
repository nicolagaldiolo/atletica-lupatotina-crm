    ...
    <div class="col-12">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-general-tab" data-coreui-toggle="tab"
                    data-coreui-target="#nav-general" type="button" role="tab" aria-controls="nav-general"
                    aria-selected="true">Generale</button>
                <button class="nav-link" id="nav-stock-tab" data-coreui-toggle="tab" data-coreui-target="#nav-stock"
                    type="button" role="tab" aria-controls="nav-stock" aria-selected="false">Magazzino</button>
                <button class="nav-link" id="nav-images-tab" data-coreui-toggle="tab" data-coreui-target="#nav-images"
                    type="button" role="tab" aria-controls="nav-images" aria-selected="false">Immagini</button>
            </div>
        </nav>
